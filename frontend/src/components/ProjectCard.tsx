...
interface ProjectCardProps {
  ...
  onClickUpdate: (project:Project) => void;
}

export function ProjectCard({ project, onDelete, onClickUpdate }: ProjectCardProps) {
  const navigate = useNavigate();
  const [delProj, setDelProj] = useState({ isDel: false, isEdit: false, opneModal: false, errTxt: "" })
  ...
  return (
    <div className="project-card">
      <div className="flex-between">
        ...
        <div className="flex-center" style={{gap:1}}>
          <button
            className="flex-center btn btn-action"
            onClick={onUpdate}
            title="Edit project"
          >
